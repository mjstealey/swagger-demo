...
class DefaultApi(object):
    ...
    def exposures_exposure_type_coordinates_get_with_http_info(self, exposure_type, **kwargs):
        ...
        return self.api_client.call_api('/exposures/{exposure_type}/coordinates', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def exposures_exposure_type_dates_get_with_http_info(self, exposure_type, **kwargs):
        ...
        return self.api_client.call_api('/exposures/{exposure_type}/dates', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def exposures_exposure_type_scores_get_with_http_info(self, exposure_type, start_date, end_date, exposure_point, **kwargs):
        ...
        if 'exposure_point' in params:
            query_params.append(('exposure_point', params['exposure_point']))
        if 'temporal_resolution' in params:
            query_params.append(('temporal_resolution', params['temporal_resolution']))
        if 'score_type' in params:
            query_params.append(('score_type', params['score_type']))
        if 'radius' in params:
            query_params.append(('radius', params['radius']))
        if 'page' in params:
            query_params.append(('page', params['page']))
        ...
        return self.api_client.call_api('/exposures/{exposure_type}/scores', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def exposures_exposure_type_values_get_with_http_info(self, exposure_type, start_date, end_date, exposure_point, **kwargs):
        ...
        if 'statistical_type' in params:
            query_params.append(('statistical_type', params['statistical_type']))
        if 'radius' in params:
            query_params.append(('radius', params['radius']))
        if 'page' in params:
            query_params.append(('page', params['page']))
        ...
        return self.api_client.call_api('/exposures/{exposure_type}/values', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def exposures_get_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/exposures', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
